<div class = "wrap" align='center'>
    <div class = "wrapper">
        <div class = "main">                 
            ...
            <table >
                <tr>
                    <td align="center"><img src="../app/webroot/img/users.png" style="cursor:pointer" id="usu"></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td align="center"><img src="../app/webroot/img/door.png" style="cursor:pointer" id="door"></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td align="center"><img src="../app/webroot/img/turnstile.png" width="100" height="148" style="cursor:pointer" id="tor"></a></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td align="center"><img src="../app/webroot/img/pasaporte.png" width="100" height="148" style="cursor:pointer" id="pas"></a></td>
                </tr>                
                <tr>
            ...
            <div id="access" name="access" style="display:none">
                <table >
                    <tr>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Locaciones", "action" => "add")) ?>"><img src="../app/webroot/img/door.png"></a></td>
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Locaciones", "action" => "index")) ?>"><img src="../app/webroot/img/door.png"></a></td>
                    </tr>                
                    <tr>
            ...
            <div id="users" name="users" style="display:none">
                <table >
                    <tr>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Users", "action" => "add")) ?>"><img src="../app/webroot/img/users.png"></a></td>
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Users", "action" => "index")) ?>"><img src="../app/webroot/img/users.png"></a></td>
                    </tr>                
                    <tr>
            ...
            <div id="torni" name="torni" style="display:none">
                <table >
                    <tr>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Torniquetes", "action" => "add")) ?>"><img src="../app/webroot/img/turnstile.png" width="100" height="148"></a></td>
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Torniquetes", "action" => "index")) ?>"><img src="../app/webroot/img/turnstile.png" width="100" height="148"></a></td>
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Torniquetes", "action" => "bloqueo")) ?>"><img src="../app/webroot/img/turnstile.png" width="100" height="148"></a></td>
                    </tr>                
                    <tr>
            ...
            <div id="pasaporte" name="pasaporte" style="display:none">
                <table>
                    <tr>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Brazaletes", "action" => "add")) ?>"><img src="../app/webroot/img/pasaporte.png" width="100" height="148"></a></td>
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align="center"><a href="<?= $this->Html->url(array("controller" => "Brazaletes", "action" => "activar")) ?>"><img src="../app/webroot/img/pasaporte.png" width="100" height="148"></a></td>
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
