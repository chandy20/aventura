<?php
App::uses('EntradasSalidasDiasParquesController', 'Controller');

/**
 * EntradasSalidasDiasParquesController Test Case
 *
 */
class EntradasSalidasDiasParquesControllerTest extends ControllerTestCase {
